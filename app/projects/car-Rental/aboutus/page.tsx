...
export const metadata: Metadata = {
  ...
  description:
    "Learn about our taxi and car rental service, safety promise, verified drivers, clean cars, and customer-first travel experience.",
};
    ...
    <main className="bg-slate-50">
      ...
      <section className="relative overflow-hidden border-b bg-white">
        ...
        <div className="relative mx-auto max-w-7xl px-4 py-14 sm:px-6 sm:py-18">
          ...
          <div className="mt-5 grid items-center gap-10 lg:grid-cols-2">
            <div>
              ...
              <h1 className="mt-5 text-4xl font-black leading-tight text-white sm:text-5xl">
                ...
                <span className="block text-green-400">
                  Trust is our first service.
                </span>
              </h1>

              <p className="mt-4 max-w-xl leading-relaxed text-slate-200">
                We are built for people who want reliable travel: on-time
                pickups, clean cars, verified drivers, and transparent
                communication. This demo page is designed to increase trust and
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="relative h-44 overflow-hidden rounded-[26px] border border-white/10 sm:h-56">
                <Image
                  src="/projects/car-Rental/images/innova.jpg"
                  alt="Innova car rental"
                  fill
          ...
          <div className="grid items-center gap-10 lg:grid-cols-2">
            <div>
              ...
              <p className="mt-3 leading-relaxed text-slate-600">
                People book when they feel safe and confident. So we communicate
                these points clearly — it boosts conversion.
              </p>
              ...
              <div className="mt-6 grid gap-3 sm:grid-cols-2">
                ...
                <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                  ...
                  <div className="mt-2 text-sm text-slate-600">
                    WhatsApp and call support for quick updates.
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="grid items-center gap-10 lg:grid-cols-2">
            <div className="rounded-[28px] border border-slate-200 bg-slate-50 p-7">
              ...
              <p className="mt-2 text-sm text-slate-600">
                Add your real city and nearby destinations later to improve
                local SEO.
              </p>
              ...
              <div className="mt-6 text-xs text-slate-500">
                Tip: add 10–20 location pages to rank better in Google locally.
              </div>
            </div>
            ...
            <div>
              ...
              <p className="mt-2 leading-relaxed text-slate-600">
                From sedan to SUV to luxury — we match the right car for your
                trip.
              </p>
          ...
          <div className="grid gap-10 lg:grid-cols-2">
            <div>
              ...
              <div className="mt-6 flex flex-col gap-3 sm:flex-row">
                ...
                <Link
                  href={ROUTES.rate}
                  className="inline-flex justify-center rounded-2xl border border-slate-200 bg-white px-6 py-3 font-extrabold text-slate-900 transition hover:bg-slate-50"
                >
                  View Rates
                </Link>
              </div>
            ...
            <div className="grid gap-3">
              ...
              <FAQ
                ...
                a="Approve the quote, then we confirm pickup time, share driver details, and your booking is confirmed."
              />
            </div>
          </div>
        </div>
            ...
            <div className="grid items-center gap-8 lg:grid-cols-2">
              <div>
                ...
                <p className="mt-3 leading-relaxed text-slate-200">
                  Tap to WhatsApp or call — we confirm best price and
                  availability.
                </p>
              ...
              <div className="grid gap-3 sm:grid-cols-2">
                {[
                  ["Clean cars", "Travel-ready and maintained"],
                  ["Verified drivers", "Safety-first policy"],
                  ["Transparent pricing", "Confirmed before trip"],
                  ["Fast response", "WhatsApp and call support"],
                ].map(([t, s]) => (
                  <div
                    key={t}
